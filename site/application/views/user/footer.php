			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						...
						<p><i class="fa fa-envelope"></i> <a href="mailto:contato@pizzarialapizza.com.br" title="Enviar um e-mail para contato@pizzarialapizza.com.br">contato@pizzarialapizza.com.br</a></p>
					</div>
				</div>
			</div>
			<div class="bg-copy">
