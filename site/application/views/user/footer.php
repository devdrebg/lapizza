			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p>1.1 Este TERMO se aplica para regular o uso do serviço oferecido pelo lapizza.com.br aos USUÁRIOS, qual seja, possibilitar a escolha, pelos USUÁRIOS cadastrados e, via on-line, efetivar solicitações para aquisição (e entrega em domicílio e retirada no local) de gêneros alimentícios fornecidos pela pizzaria LaPizza, de acordo com o cardápio disponibilizado, sendo possível, igualmente, aos USUÁRIOS, escolher a efetivação do pagamento do preço dos produtos via máquina ou dinheiro. </p>
						<p>1.2 O serviço do lapizza.com.br consiste, portanto, em aproximar, através do nosso site, os USUÁRIOS da pizzaria LaPizza, possibilitando que os USUÁRIOS encaminhem pedidos de entrega de gêneros alimentícios.</p>
						<p>1.3 Desde logo fica esclarecido ao USUÁRIO - o qual se declara ciente - que o serviço oferecido pelo lapizza.com.br se relaciona apenas à 'intermediação para comercialização de produtos alimentícios, abarcando preparo, embalagem, disponibilização e entrega física (via motoboy ou outros meios) dos produtos.</p>
						<br>
						<h3>2. CADASTRO</h3>
						<p>2.1 O USUÁRIO, para utilizar os serviços acima descritos, deverá ter capacidade jurídica para atos civis e deverá, necessariamente, prestar as informações exigidas no CADASTRO, assumindo integralmente a responsabilidade (inclusive cível e criminal) pela exatidão e veracidade das informações fornecidas no CADASTRO, que poderá ser verificado, a qualquer momento, pelo lapizza.com.br.</p> 
						<p>2.1.1 Em caso de informações incorretas, inverídicas ou não confirmadas, bem assim na hipótese da negativa em corrigi-las ou enviar documentação que comprove a correção, a pizzaria LaPizza se reserva o direito de não concluir o cadastramento em curso ou, ainda, de bloquear o cadastro já existente, impedindo o USUÁRIO de utilizar os serviços on-line até que, a critério do lapizza.com.br, a situação de anomalia esteja regularizada. O lapizza.com.br se reserva o direito de impedir, a seu critério, novos CADASTROS, ou cancelar os já efetuados, em caso de ser detectada anomalia que, em sua análise, seja revestida de gravidade ou demonstre tentativa deliberada de burlar as regras aqui descritas, obrigatórias para todos os USUÁRIOS. Também agirá o lapizza.com.br de tal forma caso verifique descumprimento, pelo USUÁRIO, de qualquer obrigação prevista no presente TERMO.</p> 
						...
						<br>
						<h3>4. OBRIGAÇÕES DO LAPIZZA.COM.BR </h3>
						<p>4.1 Disponibilizar no site lapizza.com.br espaço virtual que permita ao USUÁRIO devidamente cadastrado efetivar pedidos de compra de gêneros alimentícios anunciados e comercializados.</p> 
						...
						<p>5.2 As novas condições entrarão em vigência assim que sua veiculada no site, sendo possível ao USUÁRIO manifestar oposição a quaisquer dos termos modificados, desde que o faça por escrito, através do site lapizza.com.br, o que gerará o cancelamento de seu CADASTRO.</p>
						<br>
						<h3>6. CANAL DE COMUNICAÇÃO</h3>
						<p>6.1 Para estabelecer contato entre lapizza.com.br e o USUÁRIO fica disponibilizado o endereço eletrônico deste link, sendo certo que o USUÁRIO se obriga, igualmente, a manter em seu cadastro endereço eletrônico atual por intermédio do qual se farão as comunicações a ele dirigidas pelo lapizza.com.br, desde logo emprestando-se validade jurídica e efetividade a esse meio eletrônico de troca de informações recíprocas.</p>
						<br> 
